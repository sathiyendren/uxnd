...
const greeting = {
  ...
  data: {
    ...
    subTitle: "Megalatha",
    description:
      'An User Experience and Interaction Designer based in Bangalore, India with experience in delivering user-centric Interfaces for surface UIs. I\'m passionate about rendering intuitive UIs for people and thereby enrich the overall customer experience... <a href="#aboutMe" style={{ color: "#DBA46B" }}>{" "}Read on</a>',
